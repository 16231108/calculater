  ...
  export default {
    ...
    methods: {
      update:function(item){//[结果，算式]
        ...
        this.result_size="font-size:"+Math.max(Math.min(Math.floor(window.screen.availHeight*0.25-80),Math.floor((window.screen.availWidth*0.7-6)/item[1].length)),Math.floor(window.screen.availHeight*0.25-80)/2)+"px"
    ...
    this.update(['11','31=2'])
    this.update(['12222222222222222222','921322222222222222=222222222222222222222221'])
    },
