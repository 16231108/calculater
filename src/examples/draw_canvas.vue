<template>
    <div id="draw">
        ...
        <!--div class="config">
            <ul class="ul-config">
                <li class="li-c">
                    <span class="item-label">是否显示网格</span>
    ...
    data(){
        return {
            ...
            options:{
                ...
                canvasWidth: window.screen.availWidth*0.7-8, //canvas宽高 [Number] 可选
                canvasHeight:window.screen.availHeight*0.7-130,  //高度  [Number] 可选
                isShowBorder: true, //是否显示边框 [可选]
                bgColor: '#CCCCCC', //背景色 [String] 可选
